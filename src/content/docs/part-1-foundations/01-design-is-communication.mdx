...
<Aside type="note">
Part I's examples are in **Python**, for readability. From Part II on, every code
listing comes in both **Python** and **TypeScript** via a language toggle — because
the design, not the language, is what this book is about.
</Aside>
